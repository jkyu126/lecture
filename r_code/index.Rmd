...
- 목표: 바로 프로젝트에 투입되어 데이터 처리를 진행할 수 있는 수준으로 
...
# 코드 
- Github의 제 코드 페이지 (https://github.com/jkyu126/lecture/tree/master/r_code) 를 들어갑니다.
- 01_data_cleaning.R을 보시면 됩니다. 아래 코드와 동일합니다.
